...
# print(tp.locality(node.id).id)
#
# node = NodeAddr([0, 0], tp.dim)
# print(tp.locality(node.id).id)
#
#
# node = NodeAddr([1, 1], tp.dim)
# print(tp.locality(node.id).id)
#
# node = NodeAddr([2, 2], tp.dim)
# print(tp.locality(node.id).id)

# node = NodeAddr([2, 2], tp.dim)
# print(tp.nearest_neighbor(node.id, radius=2, nearest_prob=.6).addr)
# print(tp.nearest_neighbor(node.id, radius=1, nearest_prob=0.55).addr)
# print(tp.nearest_neighbor(node.id, radius=1, nearest_prob=0.7).addr)

# node = NodeAddr([2, 2], tp.dim)
# print(tp.hotspot(node.id).id)
# print(tp.nearest_neighbor(node.id, radius=1, nearest_prob=0.55).addr)
# print(tp.nearest_neighbor(node.id, radius=1, nearest_prob=0.7).addr)
